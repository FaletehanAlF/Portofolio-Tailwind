...
const translations = {
  en: {
    ...
    'about.s1': 'Background',
    'about.s2': 'Beyond code',
    'about.s3': 'Direction',
    'about.p1': 'I have a strong passion for Software Engineering and Full-Stack Web Development. As a Software Engineering student at SMK Taruna Bhakti, I continuously develop my technical skills through self-learning, hands-on projects, and participation in various bootcamp programs.',
    'about.p2': 'Beyond technology, I am committed to continuous learning and personal growth. I also actively participate in school activities as a futsal player, which has strengthened my teamwork, discipline, leadership, and communication skills.',
    'about.p3': 'My goal is to pursue a career as a Software Engineer and contribute by creating innovative, impactful, and user-focused digital solutions. I am open to professional networking and collaboration opportunities through LinkedIn or via email at faletehanalfarabi09@gmail.com.',
  ...
  id: {
    ...
    'about.s1': 'Latar belakang',
    'about.s2': 'Di luar kode',
    'about.s3': 'Arah',
    'about.p1': 'Saya memiliki minat yang besar pada Software Engineering dan Full-Stack Web Development. Sebagai siswa Rekayasa Perangkat Lunak di SMK Taruna Bhakti, saya terus mengembangkan keterampilan teknis melalui belajar mandiri, proyek langsung, dan partisipasi dalam berbagai program bootcamp.',
    'about.p2': 'Di luar teknologi, saya berkomitmen pada pembelajaran berkelanjutan dan pengembangan diri. Saya juga aktif berkegiatan di sekolah sebagai pemain futsal, yang mengasah kerja sama tim, kedisiplinan, kepemimpinan, dan keterampilan komunikasi saya.',
    'about.p3': 'Tujuan saya adalah berkarier sebagai Software Engineer dan berkontribusi dengan menciptakan solusi digital yang inovatif, berdampak, dan berfokus pada pengguna. Saya terbuka untuk networking profesional dan peluang kolaborasi melalui LinkedIn atau email di faletehanalfarabi09@gmail.com.',
